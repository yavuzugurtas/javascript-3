...
freeVariables.push(example_aFreeVariable);
...
freeVariables.push(example_fromGlobalScope)
...
freeVariables.push(example_fromClosure);
...
console.groupEnd();
const liveStudiedFreeVariables = liveStudy(evaluatedFreeVariables, 'Free Variables');
document.body.appendChild(liveStudiedFreeVariables.container);
