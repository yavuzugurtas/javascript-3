...
{
  const pageTitle = 'identifying closure';
...
try {
  ...
  evaluate(example_functionsReturningFunctions);
  ...
  evaluate(alwaysCreatesAClosure);
  ...
  evaluate(sometimesCreatesAClosure1);
  ...
  evaluate(sometimesCreatesAClosure2)
