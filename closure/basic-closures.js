...
basicClosures.push(example_parentValuesOwnValues);
...
console.groupEnd();
const liveStudiedBasicClosures = liveStudy(evaluatedBasicClosures, 'Basic Closures');
document.body.appendChild(liveStudiedBasicClosures.container);
