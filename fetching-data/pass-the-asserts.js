...
passTheAsserts.push(passTheAsserts2);
...
passTheAsserts.push(passTheAsserts3);
...
passTheAsserts.push(passTheAsserts4);


const fetchingPassTheAsserts = passTheAsserts.map(fetching);
const liveStudiedPassTheAsserts = liveStudy(fetchingPassTheAsserts, 'Pass The Asserts');
document.body.appendChild(liveStudiedPassTheAsserts.container);
